...
class AppLocalizationsEn extends AppLocalizations {
  ...
  String settingsBiometricSupportedSubtitle(Object biometricLabel) {
    return 'Use $biometricLabel to reopen the local session. If device biometric recovery remains valid, it also works after app restart.';
  }
  ...
  @override
  String get settingsRoadmapNotes => 'Vault items are encrypted with AES-256-GCM using a PBKDF2-HMAC-SHA256-derived key from the master password. The key stays only in memory for the current session; reliable sync and biometric recovery across restarts are still pending.';
  ...
  @override
  String get securityChecklistHash => 'PBKDF2-HMAC-SHA256 verifies the master password.';

  @override
  String get securityChecklistDerive => 'A separate PBKDF2-HMAC-SHA256 derives the vault key.';
  ...
  String securityBiometricAvailable(Object biometricLabel) {
    return 'Link $biometricLabel for quick unlock on this device.';
  }
